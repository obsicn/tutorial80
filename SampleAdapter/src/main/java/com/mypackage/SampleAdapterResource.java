...
@Path("/resource")
public class SampleAdapterResource {
	/*
	...
	static Logger logger = Logger.getLogger(SampleAdapterResource.class.getName());
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/SampleAdapter/resource"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/SampleAdapter/resource/greet/{name}"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/SampleAdapter/resource/{path}/"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/SampleAdapter/resource/prop"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/SampleAdapter/resource/unprotected"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/SampleAdapter/resource/protected"
	 */
